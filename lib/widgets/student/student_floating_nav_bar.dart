...
/// Floating capsule navigation dock for the Student Panel,
/// styled with the signature Unisphere Frosted Glass & Royal Blue Design System.
///
/// Order of items:
/// 1. More (Grid Icon / Application -> Opens Student Navigation Drawer / Sheet)
/// 2. Resume / Career (Resume / Academics Icon -> Opens Professional Resume)
/// 3. Home (Home Icon -> Switches to Home Dashboard)
/// 4. Profile (Person Icon -> Switches to Student Profile)
...
class StudentFloatingNavBar extends StatelessWidget {
  ...
  /// Slot 0: More (isMenuOpen == true)
  /// Slot 1: Resume / Academics (index 19 or index 1)
  /// Slot 2: Home (index 0)
  /// Slot 3: Profile (index 24)
  /// Slot 4: Logout (action button)
  int get _activeSlot {
    if (isMenuOpen) return 0;
    if (currentIndex == 0) return 2;
    if (currentIndex == 19 || currentIndex == 1) return 1;
