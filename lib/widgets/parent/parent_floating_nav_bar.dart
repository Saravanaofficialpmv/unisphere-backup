...
/// 2. Classes (Attendance & Classes)
/// 3. Center "U" Button (Navigation Launcher Sheet)
...
class ParentFloatingNavBar extends StatelessWidget {
  ...
  UnisphereNavSlot get _activeSlot {
    ...
    if (currentIndex == 1) return UnisphereNavSlot.classes;
    if (currentIndex == 0) return UnisphereNavSlot.home;
    if (currentIndex == 2) return UnisphereNavSlot.notifications;
    if (currentIndex == 4) return UnisphereNavSlot.profile;
