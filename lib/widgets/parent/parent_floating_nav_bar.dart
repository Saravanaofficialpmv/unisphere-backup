...
/// Floating capsule navigation dock for the Parent Panel,
/// styled with the signature Unisphere Frosted Glass & Royal Blue Design System.
///
/// Order of items:
/// 1. More (Grid Icon / Application -> Opens Parent Navigation Drawer / Sheet)
/// 2. Attendance (Calendar / Attendance Icon -> Opens Ward Attendance & Leaves)
/// 3. Home (Home Icon -> Switches to Parent Home Dashboard)
...
class ParentFloatingNavBar extends StatelessWidget {
  ...
  /// Slot 1: Attendance (index 1 or index 2)
  /// Slot 2: Home (index 0)
  ...
  int get _activeSlot {
    ...
    if (currentIndex == 1 || currentIndex == 2) return 1;
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                // 2. Attendance (Calendar / Attendance icon)
                                Expanded(
                                  child: _NavBarItem(
                                    imageAsset: 'assets/calendar.png',
                                    icon: Icons.calendar_today_rounded,
                                    tooltip: 'Ward Attendance',
