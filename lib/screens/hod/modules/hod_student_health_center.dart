...
/// Layer 3: Student Command Center & Student Risk Engine
///
/// Provides deep visibility into student risk factors, attendance deficits,
/// academic standing, and advisory interventions.
class HodStudentHealthCenter extends ConsumerWidget {
  final VoidCallback? onNavigateToStudents;

  const HodStudentHealthCenter({
    super.key,
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: (riskProfiles.isNotEmpty ? AppColors.error : AppColors.success).withValues(alpha: 0.1),
                borderRadius: BorderRadius.circular(12),
              ),
              child: Text(
                '${riskProfiles.length} Students',
                style: TextStyle(
                  fontSize: 11,
                  fontWeight: FontWeight.bold,
                  color: riskProfiles.isNotEmpty ? AppColors.error : AppColors.success,
                ),
              ),
            ),
          ],
        ...
        if (riskProfiles.isEmpty)
          AppleGlassCard(
            ...
            child: Row(
              ...
              children: const [
                ...
                Flexible(
                  child: Text(
                    'No students currently at academic risk in the department',
                    style: TextStyle(
                      fontSize: 13,
          ...
          Column(
            children: [
              ...riskProfiles.take(5).map((profile) => _buildStudentTile(context, profile)),
              if (riskProfiles.length > 5 && onNavigateToStudents != null)
                Padding(
  ...
  Widget _buildStudentTile(BuildContext context, StudentRiskProfile profile) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: profile.riskLevel == HodPriorityLevel.critical
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                CircleAvatar(
                  radius: 18,
                  backgroundColor: profile.riskLevel.backgroundColor,
                  child: Text(
