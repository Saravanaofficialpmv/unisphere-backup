...
/// Layer 4: Today's Operations
///
/// Surfaces real-time departmental lecture schedules, live sessions,
/// room allocations, and faculty coverage.
class HodTodayOperations extends ConsumerWidget {
  final VoidCallback? onNavigateToTimetable;

  const HodTodayOperations({
    super.key,
