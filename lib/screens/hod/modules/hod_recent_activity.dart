...
/// Recent Department Activity feed displaying audit and event logs in real time.
class HodRecentActivity extends ConsumerWidget {
  const HodRecentActivity({super.key});
